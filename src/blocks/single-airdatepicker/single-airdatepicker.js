  ...
  (function() {
    var VERSION = "2.2.3",
      ...
      defaults = {
        ...
        nextHtml:
          '<svg><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z"/></svg>',
        navTitles: {
          days: "MM, <i>yyyy</i>",
          months: "yyyy",
          years: "yyyy1 - yyyy2"
    ...
    datepicker.prototype = {
      ...
      init: function() {
        if (!containerBuilt && !this.opts.inline && this.elIsInput) {
          this._builddatepickerContainer();
        }
        this._buildBaseHtml();
      ...
      _builddatepickerContainer: function() {
        containerBuilt = true;
        $body.append(
      ...
      _buildBaseHtml: function() {
        ...
        if (this.el.nodeName == "INPUT") {
          if (!this.opts.inline) {
            $appendTarget = $datepickerContainer;
          } else {
